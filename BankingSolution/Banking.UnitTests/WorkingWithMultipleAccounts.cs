...
public class WorkingWithMultipleAccounts
{
    ...
    {
        var bobsAccount = new BankAccount(new Mock<ICalculateBonuses>().Object, new Mock<INotifyAccountReps>().Object);
        var suesAccount = new BankAccount(new Mock<ICalculateBonuses>().Object, new Mock<INotifyAccountReps>().Object);
